...
package com.chenfanyf.demo2.common.api;
...
public enum ApiCode {
    ...
    USER_NAME_TAKEN(6001, "用户名被占用"),
    EMAIL_TAKEN(6002, "邮箱已注册"),
    SECURITY_CODE_INVALID(6003, "验证码不正确"),
    SECURITY_CODE_EXPIRED(6004, "验证码过期"),
    USER_NOT_FOUND(6005, "用户不存在"),
    PASSWORD_MISMATCH(6007, "密码不正确"),
    PROFILE_NOT_SET(6008, "尚未进行认证"),


    UNIMPLEMENTED(9000, "功能未开通"),
    ;
